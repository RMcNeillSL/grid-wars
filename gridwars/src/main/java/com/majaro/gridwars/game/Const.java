...
public final class Const {
	...
	public enum E_GameplayRequestCode {
		...
		UNKNOWN("UNKNOWN"), DAMAGE_OBJECT("DAMAGE_OBJECT"), DEBUG_PLACEMENT("DEBUG_PLACEMENT"), OBJECT_ATTACK_OBJECT("OBJECT_ATTACK_OBJECT"),
	...
	public enum E_GameplayResponseCode { 
		...
		OBJECT_ATTACK_OBJECT("OBJECT_ATTACK_OBJECT"), DESTROY_OBJECT("DESTROY_OBJECT"),
		...
		DYNAMIC_MAP_OBSTRUCTION("DYNAMIC_MAP_OBSTRUCTION"), DEFENCE_ATTACK_XY("DEFENCE_ATTACK_XY"), SELL_BUILDING("SELL_BUILDING"),
