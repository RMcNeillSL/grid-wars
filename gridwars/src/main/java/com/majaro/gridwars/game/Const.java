...
public final class Const {
	...
	public enum E_GameplayResponseCode { 
		...
		NEW_BUILDING("NEW_BUILDING"), STATIC_MAP_OBSTRUCTION("STATIC_MAP_OBSTRUCTION"), OUT_OF_MAP_BOUNDS("OUT_OF_MAP_BOUNDS"), DYNAMIC_MAP_OBSTRUCTION("DYNAMIC_MAP_OBSTRUCTION"), 
